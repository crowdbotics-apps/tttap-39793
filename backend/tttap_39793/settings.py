"""
Django settings for tttap_39793 project.
...
WSGI_APPLICATION = 'tttap_39793.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tttap_39793 API",
    "DESCRIPTION": "API documentation for tttap_39793 App",
    "VERSION": "v1",
}
